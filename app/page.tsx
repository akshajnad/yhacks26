...
const findings = [
  {
    label: "Duplicate pharmacy charge",
    code: "99213",
    amount: "$340",
    status: "error",
  },
  {
    label: "CPT code mismatch",
    code: "27447",
    amount: "$2,100",
    status: "error",
  },
  {
    label: "Responsibility miscalculation",
    code: "—",
    amount: "$618",
    status: "warn",
  },
  {
    label: "In-network rate confirmed",
    code: "93000",
    amount: "$95",
    status: "ok",
  },
...
const stats = [
  {
    figure: "9 in 10",
    label: "hospital bills contain at least one error",
    accent: "#F87171",
  },
  {
    figure: "78%",
    label: "who challenged got charges reduced or removed",
    accent: "#60A5FA",
  },
  {
    figure: "$220B",
    label: "in medical debt held by Americans",
    accent: "#ffde8e",
  },
  {
    figure: "64%",
    label: "of patients have never once challenged a bill",
    accent: "#E5E7EB",
  },
];
...
const UploadPreview = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
    ...
    >
      <p style={{ fontSize: 13, color: "#9B8F80", fontFamily: "sans-serif" }}>
  ...
  >
    ...
    {findings.map((row, i) => (
      ...
      >
        ...
        <span
          style={{ fontSize: 11, color: "#9B8F80", fontFamily: "monospace" }}
        >
          {row.code}
        </span>
        <span
  ...
  >
    ...
    >
      {[
        ...
        {
          text: "Duplicate charge on line 3 (CPT 99213) — $340",
          kind: "error",
        },
        ...
        <div key={i} style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span
            style={{
              ...
              height: 7,
              borderRadius: "50%",
              backgroundColor: line.kind === "error" ? "#DC2626" : "#9B8F80",
              display: "inline-block",
              flexShrink: 0,
            }}
          />
          <span
            style={{ fontSize: 13, color: "#1a1a1a", fontFamily: "sans-serif" }}
          >
            {line.text}
          </span>
          {line.kind === "error" && (
...
const steps = [
  ...
  },
  {
    ...
    detail: "Pre-filled, ready to send.",
  ...
  const ctaButton =
    !isLoading && user ? (
      ...
      <div
        ...
        style={{ width: 160, height: 100, backgroundColor: "#E8E2D9" }}
      />
    );
    ...
    >
          ...
          <div style={{ perspective: 1200 }}>
            <div
              style={{
                ...
                padding: 22,
                boxShadow:
                  "0 32px 80px rgba(0,0,0,0.11), 0 4px 20px rgba(0,0,0,0.05)",
              }}
            >
              <div
                style={{
      ...
      <section style={{ backgroundColor: "#111" }}>
        ...
        >
          {stats.map((s) => (
            <div
              key={s.figure}
              style={{ backgroundColor: "#111", padding: "70px 28px" }}
            >
              <p
                style={{
      ...
      >
        ...
        >
          ...
          <span
            style={{ fontSize: 11, color: "#374151", fontFamily: "sans-serif" }}
          >
            Auth0 secured · HIPPA Compliant{" "}
          </span>
        </div>
      </footer>
    </div>
