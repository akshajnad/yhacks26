...
function normalizeResponse(parsed: any): {
  ...
  return {
    extractedFields: {
      ...
      providerPhone: ef.providerPhone || "860 593 8988",
      providerEmail: ef.providerEmail || "chavasujay91@gmail.com",
      insurerPhone: ef.insurerPhone || "860 593 8988",
      insurerEmail: ef.insurerEmail || "chavasujay91@gmail.com",
